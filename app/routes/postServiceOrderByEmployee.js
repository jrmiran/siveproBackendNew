...
module.exports = function(app, postServiceOrderByEmployee){
    ...
    app.post(`/${postServiceOrderByEmployee}`, function(req, res){
        ...
        let sql = `SELECT * FROM OrdemServico_funcionarios; SELECT * FROM OrdemServico_porcentagens;SELECT id, valor, dataTermino, empreita, pedra, valorEmpreita, valorPedra FROM OrdemServico;`
