...
module.exports = function(app, budgetUpdate){
    ...
    app.get(`/${budgetUpdate}/:budgetId/:discount/:note/:retified/:amount/:budgetCodes/:budgetAmbients/:budgetDetails/:budgetItems/:budgetMeasures/:budgetNeedings/:budgetNumbers/:budgetQuantitys/:budgetValues`, function(req, res){
        //con.connect();
        let sql = ` UPDATE Orcamento SET desconto = ${req.params.discount}, observacao = ${req.params.note}, retificado = ${req.params.retified}, valotTotal = ${req.params.amount} WHERE Orcamento.id = ${req.params.budgetId};
                    ...
                    Insert into Orcamento_comodos (Orcamento_id, comodos) values ${req.params.budgetCodes};
