...
module.exports = function(app, budgetVendor){
    ...
    app.get(`/${budgetVendor}/:nameEmpresa/:nameVendor`, function(req, res){
        ...
        let sql = `select v.telefone, v.celular, v.email, v.id as id_vendor, c.id as id_client from Cliente as c, Vendedor as v where c.nome = ${req.params.nameEmpresa} and v.nome = ${req.params.nameVendor}`
